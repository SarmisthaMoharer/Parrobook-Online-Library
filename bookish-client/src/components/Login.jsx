        ...
        <div className="relative py-3 sm:max-w-xl sm:mx-auto">
            ...
            <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                <div className="max-w-md mx-auto">
                    ...
                    <h1 className="mt-5 text-2xl font-semibold text-green-900 underline ">Log in Form</h1>
                    </div>
                    <div className="divide-y divide-gray-200">
                        <form onSubmit={handleLogIn} className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                            ...
                            <div className="relative">
                              ...
                              {
                                error ? <p className='text-rose-500'>Email or Password is incorrect!!</p> : ""
                              }
                            <p>If you don't have an account . Please <Link to="/sign-up" className='text-blue-600 underline'>Sign Up</Link> Here</p>
                            <div className="relative">
                                <button onClick={handleRegister} className="bg-teal-500 text-white rounded-md px-6 py-2">Log in</button>
                            </div>
